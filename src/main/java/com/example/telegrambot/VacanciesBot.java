...
public class VacanciesBot extends TelegramLongPollingBot {
    ...
    public VacanciesBot() {
        super("6257361979:AAEQayxCdGXCEVBNOINkLZTNKKF0iunAv3g");
    }
    ...
    public void onUpdateReceived(Update update) {
        try {
            ...
            throw new RuntimeException("Cant send message to user!", e);
        }
    }
...
//    }
    ...
    private ReplyKeyboard getBackToVacanciesMenu() {
        ...
        getChatGptButton.setText("Get covet letter");
